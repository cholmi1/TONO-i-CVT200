...
const GUIDE_ITEMS = [
  ...
  },
  {
    num: 2,
    title: '메인 메뉴 (Menu)',
    desc: '앱의 메인 컨트롤 센터입니다. 기기연결, 안압관리, 기록확인, 기록전송 기능으로 이동하며, 하단에서 기기의 실시간 연결 현황을 직관적으로 확인할 수 있습니다.'
  },
  {
    num: 3,
    title: '기기연결 / 측정 (Record)',
    desc: '안압 측정 인터페이스입니다. 블루투스 설정을 터치하여 가상으로 기기를 페어링할 수 있으며, "자동측정" 토글 활성화 시 3초마다 자동으로 가상 안압 측정값을 수집하여 데이터에 보존합니다.'
  },
  {
    num: 4,
  ...
  },
  {
    num: 5,
    title: '안압 기록 (History)',
    desc: '측정된 안압과 점안 이력을 한눈에 보는 타임라인입니다. 상단에서 좌/우안을 필터링할 수 있으며, 이력 리스트의 항목을 터치하면 [점안결과] 상세 정보(날짜, 시간, 점안기기, 안약명 등)를 직접 편집하고 삭제할 수 있는 특수 모달 팝업이 노출됩니다.'
  },
  {
    num: 6,
