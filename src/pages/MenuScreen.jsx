import { Eye, FileText, Upload, RefreshCw, Info } from 'lucide-react'
import { GlassCard } from '../components/ui/GlassCard'

const MenuButton = ({ icon: Icon, label, onClick }) => (
  <GlassCard
    className="flex flex-col items-center justify-center aspect-square cursor-pointer active:scale-95 transition-transform hover:bg-white/20 border-white/20 bg-white/5"
    onClick={onClick}
  >
  ...
  return (
    <div className="flex flex-col h-full text-white">
      ...
      <div className="flex-1 flex flex-col justify-center">
        <div className="grid grid-cols-2 gap-5 w-full max-w-[280px] mx-auto mb-8">
          <MenuButton
            icon={RefreshCw}
            label="기기연결"
